            ...
            <div className="col-lg-4 mx-auto">
              <div className="auth-form-light text-left py-5 px-4 px-sm-5">
                ...
                <form className="pt-3">
                  ...
                  <div className="mt-3">
                    <a className="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="/dashboard">SIGN UP</a>
                  </div>
                  <div className="text-center mt-4 font-weight-light">
                    Already have an account? <a href="/user-pages/login" className="text-primary">Login</a>
                  </div>
                </form>
              </div>
            </div>
