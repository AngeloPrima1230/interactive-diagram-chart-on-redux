...
var entityReducer = function entityReducer() {
  ...
  switch (action.type) {
	...
	case 'rd/entity/ADD_LINK':
	{
		var _action$payload6 = action.payload,
            _id6 = _action$payload6.id,
            _link = _action$payload6.link;

        return state.map(function (entity) {
			let links = "linksTo" in entity ? [...entity.linksTo, _link] : [_link];
          return entity.id === _id6 ? _extends({}, entity, { linksTo:links}) : entity;
        }); 
	}
...
export var addLink = function addLink(payload){
	return {
		type: 'rd/entity/ADD_LINK',
		payload: payload 
	}
}
