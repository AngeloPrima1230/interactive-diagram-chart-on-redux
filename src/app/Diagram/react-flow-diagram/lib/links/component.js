...
var ArrowBody = function ArrowBody(_ref) {
  ...
  var points = _ref.points,
      id = _ref.id,
      label = _ref.label,
      onClick = _ref.onClick || showError;

  // let interLine = React.createElement(InteractionLine, { d: points });
  // interLine.props.onClick = function(){
  //   console.log('int')
  // }
  return React.createElement(
    ...
    React.createElement(InteractionLine, { d: points, style: { cursor: 'move' }, onClick : e=>{onClick('line'+id)} }),
